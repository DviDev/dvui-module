...
class DvUiServiceProvider extends ServiceProvider
{
    ...
    protected function registerComponents()
    {
        ...
        Blade::component('dvui::icon.arrow.left.onretangle', Arrow\Left\OnRectangle::class);
        ...
        Blade::component('dvui::icon.chevron.leftmini', Icon\Chevron\LeftMini::class);
        Blade::component('dvui::icon.chevron.rightmini', Icon\Chevron\RightMini::class);
        ...
        Blade::component('dvui::icon.trash', Icon\Trash::class);
        ...
        Blade::component('dvui::icon.academiccap', Icon\AcademicCap::class);
        Blade::component('dvui::icon.atsymbol', Icon\AtSymbol::class);
        Blade::component('dvui::icon.backspace', Icon\Backspace::class);
        Blade::component('dvui::icon.backward', Icon\Backward::class);
        Blade::component('dvui::icon.banknotes', Icon\Banknotes::class);
        Blade::component('dvui::icon.briefcase', Icon\Briefcase::class);
        Blade::component('dvui::icon.cake', Icon\Cake::class);
        Blade::component('dvui::icon.calculator', Icon\Calculator::class);
        Blade::component('dvui::icon.clock', Icon\Clock::class);
        Blade::component('dvui::icon.film', Icon\Film::class);
        Blade::component('dvui::icon.fire', Icon\Fire::class);
        Blade::component('dvui::icon.flag', Icon\Flag::class);
        Blade::component('dvui::icon.forward', Icon\Forward::class);
        Blade::component('dvui::icon.funnel', Icon\Funnel::class);
        Blade::component('dvui::icon.gift', Icon\Gif::class);
        Blade::component('dvui::icon.hashtag', Icon\Hashtag::class);
        Blade::component('dvui::icon.heart', Icon\Heart::class);
        Blade::component('dvui::icon.home', Icon\Home::class);
        Blade::component('dvui::icon.identification', Icon\Identification::class);
        Blade::component('dvui::icon.index', Icon\Icon::class);
        Blade::component('dvui::icon.instagram', Icon\Instagram::class);
        Blade::component('dvui::icon.key', Icon\Key::class);
        Blade::component('dvui::icon.language', Icon\Language::class);
        Blade::component('dvui::icon.lifebuoy', Icon\Lifebuoy::class);
        Blade::component('dvui::icon.link', Icon\Link::class);
        Blade::component('dvui::icon.megaphone', Icon\Megaphone::class);
        Blade::component('dvui::icon.microphone', Icon\Microphone::class);
        Blade::component('dvui::icon.moon', Icon\Moon::class);
        Blade::component('dvui::icon.newspaper', Icon\Newspaper::class);
        Blade::component('dvui::icon.nosymbol', Icon\NoSymbol::class);
        Blade::component('dvui::icon.photo', Icon\Photo::class);
        Blade::component('dvui::icon.power', Icon\Power::class);
        Blade::component('dvui::icon.printer', Icon\Printer::class);
        Blade::component('dvui::icon.qrcode', Icon\Qrcode::class);
        Blade::component('dvui::icon.radio', Icon\Radio::class);
        Blade::component('dvui::icon.receiptpercent', Icon\ReceiptPercent::class);
        Blade::component('dvui::icon.rss', Icon\Rss::class);
        Blade::component('dvui::icon.scale', Icon\Scale::class);
        Blade::component('dvui::icon.scissors', Icon\Scissors::class);
        Blade::component('dvui::icon.share', Icon\Share::class);
        Blade::component('dvui::icon.sparkles', Icon\Sparkles::class);
        Blade::component('dvui::icon.star', Icon\Star::class);
        Blade::component('dvui::icon.sun', Icon\Sun::class);
        Blade::component('dvui::icon.tag', Icon\Tag::class);
        Blade::component('dvui::icon.ticket', Icon\Ticket::class);
        Blade::component('dvui::icon.trash', Icon\Trash::class);
        Blade::component('dvui::icon.trophy', Icon\Trophy::class);
        Blade::component('dvui::icon.truck', Icon\Truck::class);
        Blade::component('dvui::icon.tv', Icon\Tv::class);
