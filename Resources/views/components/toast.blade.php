    ...
    >
        <p class="font-bold flex space-x-1 items-center"
           x-bind:class="{
            ...
            <svg x-show="toastType === 'default'" aria-hidden="true" focusable="false" data-prefix="fas"
            ...
            <x-dvui::icon.check.circle x-show="toastType === 'primary'" s5 @click="closeToast()"
                                       style="margin: 2px" class="cursor-pointer"/>
            <x-dvui::icon.check.circle x-show="toastType === 'success'" fill s5 @click="closeToast()"
                                       style="margin: 2px" class="cursor-pointer"/>
            <x-dvui::icon.exclamation.triangle x-show="toastType === 'warning'" fill s5 @click="closeToast()"
                                       style="margin: 2px" class="cursor-pointer"/>
            <x-dvui::icon.shield.exclamation x-show="toastType === 'danger'" fill s5 @click="closeToast()"
                                       style="margin: 2px" class="cursor-pointer"/>
